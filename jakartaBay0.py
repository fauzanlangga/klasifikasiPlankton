...
TRAIN_PATH = '/home/ngu0270182/jakartabay/nfold0/train/'
TEST_PATH = '/home/ngu0270182/jakartabay/nfold0/test/'
...
################################
#Modelcheckpoint
modelPath = r'/home/ngu0270182/jakartabay/model_fold0'
checkpointer = keras.callbacks.ModelCheckpoint(os.path.join(modelPath,'modelJakartaBaynFold0.h5'), verbose=1, save_best_only=True)
...
with open(os.path.join(r'/home/ngu0270182/jakartabay/model_fold0',modelJsonFileNm), "w") as json_file:
    json_file.write(model_json)

modelRd.save_weights(os.path.join(r'/home/ngu0270182/jakartabay/model_fold0',modelH5FileNm))
...
pathToSave = r'/home/ngu0270182/jakartabay/result0'
...
print("jakartaBay0.py has been run!")
